...
void carmen_get_date(char *time_string)
{
  struct timeval tv;
  struct tm *ptm;
...
void carmen_perror(const char *fmt, ...)
{
  va_list args;
...
void carmen_die_syserror(const char *fmt, ...)
{
  va_list args;
...
void carmen_warn(const char *fmt, ...)
{
  va_list args;
...
void carmen_verbose(const char *fmt, ...)
{
  va_list args;
...
int carmen_line_to_line_intersection(carmen_position_t *I0, carmen_position_t s1_p0, carmen_position_t s1_p1, carmen_position_t s2_p0, carmen_position_t s2_p1)
{
...
int carmen_line_to_point_crossed_rectangle(carmen_position_t *nearest_intersection, carmen_position_t origin, carmen_position_t point, carmen_rectangle_t rectangle)
{
