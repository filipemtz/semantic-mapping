...
int add_connections_between_pair_logs(
...
void add_interlog_connections(vector<DatasetCarmen> &input_data,
...
void create_graph(vector<DatasetCarmen> &input_data,
...
void save_corrected_vertices_from_datasets(
